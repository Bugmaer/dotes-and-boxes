class Game:
    ...
    def verificarVencedor(self):
        totalQuadrados = len(self.quadradosCompletos) * len(self.quadradosCompletos[0])
        if self.pontosJogador1 + self.pontosJogador2 == totalQuadrados:
            print("Jogo terminado!")
            if self.pontosJogador1 > self.pontosJogador2:
                print("Vencedor: Jogador 1!")
            elif self.pontosJogador2 > self.pontosJogador1:
